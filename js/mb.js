   ...
   if(rNo==1)
   {
     //insert  Bill details to Billing
      ...
      if (this.readyState == 4 && this.status == 200) {
        ...
        var msg=myArray['bid'];
        document.getElementById("bno").innerHTML=msg;
      }
    };
...
function getItemNames(xhhtp)
{
  ...
  for( var i=0;i<myArray.length;i++)
  {
   ...
   getDetails("/php/getAllItems.php",getItemNames);
...
function generateBill()
{
  ...
  document.getElementById("apB").style.display='none';
  document.getElementById("gnBill").style.display='none';
...
function sendingRow(preP)
{
  ...
  {
   var url="/php/addBillingItemInfo.php";
